...
import { BrowserTools } from '@dav-ai/core/tools/browser-tools.js';
import { Neo4jTools } from '@dav-ai/core/tools/neo4j-tools.js';
import { DavAgent } from '@dav-ai/core/agent/dav-agent.js';
...
app.get('/api/graph', async (req, res) => {
  try {
    ...
    const session = neo4jTools['driver'].session();
